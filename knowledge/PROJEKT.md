...
| M3 | NER + Wikidata | Entity recall >70%, linking >50% | **Done** (285 Docs, 11,685 Entities, 2,101/4,504 Entities Linked = 47%. Workflow: [WIKIDATA-WORKFLOW](WIKIDATA-WORKFLOW.md)) |
...
| Entity Index | **Done** | 4,504 Eintraege in `data/entities/`, 2,101 mit Wikidata/GND (47%). Diagnostik: `--diagnostics --export-csv` |
...
| Evaluation + Dashboard | Done | `scripts/evaluate_ocr.py` + `benchmark_cer.py --pagewise` + `docs/index.html` |
