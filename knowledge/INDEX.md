...
| [ARCHITEKTUR](ARCHITEKTUR.md) | Wie ist die Pipeline technisch aufgebaut? | Entwicklung | PROJEKT |
| [QUELLENANALYSE](QUELLENANALYSE.md) | Was ist das Material? Welche Dokumenttypen gibt es? | Alle | — |
| [OCR-ENGINES](OCR-ENGINES.md) | Welche OCR-Tools werden eingesetzt und wie? | Entwicklung | ARCHITEKTUR |
...
| [INFRASTRUKTUR](INFRASTRUKTUR.md) | Wie wird deployed? Azure, Podman, CI/CD? | Entwicklung, Ops | ARCHITEKTUR |
...
├── ARCHITEKTUR.md        # Technische Pipeline-Architektur
