...
created: 2026-08-21
updated: 2026-08-21
tags: [zbz-ocr-tei, journal, archive]
related: [journal, decisions]
authors: [Christopher Pollin]
---

# Journal Archive

This document holds the full entries of sessions 69 to 96 verbatim, moved out of
[journal.md](journal.md) on 2026-08-21 by operator decision and ordered newest first;
the compact lines of the journal's archive block point here. Entries are never changed
retroactively, so corrections are written as new entries in the journal and reference
