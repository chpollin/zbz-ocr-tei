"""
Overlay-Zeichnung und Koordinaten-Konvertierung der Layout-Analyse.

Genutzt von: run_layout_analysis.py, run_layout_cloud.py, layout_qa_gemini.py.
Liegt bewusst nicht im Paket-__init__: PIL wuerde sonst bei jedem Import eines
beliebigen scripts.layout-Moduls mitgeladen.
"""
