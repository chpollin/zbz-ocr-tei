...
# Testplan (aus data/testplan.json)
...
# Bekannte GND-Entitaeten (aus data/known_entities.json)
KNOWN_ENTITIES = json.loads((DATA_DIR / "known_entities.json").read_text(encoding="utf-8"))
