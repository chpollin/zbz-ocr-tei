...
Gegenüber der Erstfassung von v3 sind die Ergebniszahlen der zwei letzten Bestandskorrektur-Läufe (Seitenzahlen, Fußnoten-Demotion), die finale Warnungsbilanz der Validierung und die adjudizierte Einordnung des Dokuments 30 nachgetragen; alle im Text genannten Werte sind gemessen.
...
- Auf der Datenseite bleiben extern zu klären die drei nicht gelieferten Texte (1745, 1750, 1970) und das gelieferte PDF ohne finales TEI (Dokument 10). Von den zwei registrierten Einzeldefekten ist einer behoben. Die Seite mit geleakter Modell-Absage infolge degenerierter Basis-OCR (Dokument 1520, Seite 70) trägt nach einer Einzelseiten-Reparatur eine ehrliche Teiltranskription mit markierten unleserlichen Stellen; die Volltranskription braucht einen besseren Scan. Der zweite, der adjudizierte Textverlust der ersten Doppelseite des Dokuments 30 (6.4), wartet auf dieselbe gezielte Nachbearbeitung.
